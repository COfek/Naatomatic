"""Registry smoke test — proves all domain tool modules import cleanly, tool names
are globally unique (registry raises on a duplicate), and specs build."""

from __future__ import annotations

from tools.registry import MUTATING, DOMAIN_OF, SPECS, TOOLS_BY_NAME
