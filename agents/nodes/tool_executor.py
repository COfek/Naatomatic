...
tool through the shared registry and puts the ToolResult back on the state for the
Worker's next turn."""
...
def run(state: GraphState) -> GraphState:
    ...
    # Tools self-validate (apply -> rules -> commit/rollback) and return a ToolResult.
